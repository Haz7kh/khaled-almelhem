    ...
    <section id="about" data-aos="fade-in">
      <div className="container about-container">
        ...
        <div className="about-right">
          ...
          <p>
            👋 I'm a passionate junior applications/web developer with a strong
            focus on creating engaging and user-friendly digital experiences. My
          ...
          <p>
            ...
            projects. Besides being a developer, I possess a creative side as
            well. I enjoy exploring graphic design, including crafting unique
            logos and engaging videos. Whether it's photo editing or video
            manipulation, I love adding an artistic touch to my projects. Having
            worked with WordPress extensively, I can confidently navigate its
            ecosystem to create captivating and content-rich websites. My
            ...
            always excited to take on new challenges and embark on innovative
            projects that make a positive impact on people's lives. If you have
            any exciting projects or opportunities, let's connect! I'm eager to
            share my passion for development and design and bring your ideas to
